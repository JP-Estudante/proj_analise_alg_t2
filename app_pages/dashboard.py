...
with st.sidebar:
    ...
    sidebar_summary_html = (
        ...
        f'<div class="sidebar-summary-row"><span class="sidebar-summary-label">Vértices</span><span class="sidebar-summary-value">{sidebar_sizes_text}</span></div>'
...
if (
    run_button
    or "benchmark_df" not in st.session_state
...
with tab_table:
    ...
    styled_df = (
        ...
        .set_properties(
            subset=["Vértices", "Arestas", "Densidade", "Repetições", "Seed", "Tempo Médio (s)", "Memória Média (KB)"],
            **{"text-align": "right"},
        )
        .set_properties(
            subset=["Algoritmo"],
